    ...
    public sealed class BuildSystemTests
    {
        public sealed class TheConstructor
        {
            ...
            public void Should_Throw_If_AppVeyor_Is_Null()
            {
                ...
                // When
                var result = Record.Exception(() => new BuildSystem(null, teamCityProvider, myGetProvider, bambooProvider, continuaCIProvider, jenkinsProvider, bitriseProvider, travisCIProvider, bitbucketPipelinesProvider, gitlabCIProvider));
            ...
            public void Should_Throw_If_TeamCity_Is_Null()
            {
                ...
                // When
                var result = Record.Exception(() => new BuildSystem(appVeyorProvider, null, myGetProvider, bambooProvider, continuaCIProvider,  jenkinsProvider, bitriseProvider, travisCIProvider, bitbucketPipelinesProvider, gitlabCIProvider));
            ...
            public void Should_Throw_If_MyGet_Is_Null()
            {
                ...
                // When
                var result = Record.Exception(() => new BuildSystem(appVeyorProvider, teamCityProvider, null, bambooProvider, continuaCIProvider,  jenkinsProvider, bitriseProvider, travisCIProvider, bitbucketPipelinesProvider, gitlabCIProvider));
            ...
            public void Should_Throw_If_Bamboo_Is_Null()
            {
                ...
                // When
                var result = Record.Exception(() => new BuildSystem(appVeyorProvider, teamCityProvider, myGetProvider, null, continuaCIProvider,  jenkinsProvider, bitriseProvider, travisCIProvider, bitbucketPipelinesProvider, gitlabCIProvider));
            ...
            public void Should_Throw_If_ContinuaCI_Is_Null()
            {
                ...
                // When
                var result = Record.Exception(() => new BuildSystem(appVeyorProvider, teamCityProvider, myGetProvider, bambooProvider, null,  jenkinsProvider, bitriseProvider, travisCIProvider, bitbucketPipelinesProvider, gitlabCIProvider));
            ...
            public void Should_Throw_If_Jenkins_Is_Null()
            {
                ...
                // When
                var result = Record.Exception(() => new BuildSystem(appVeyorProvider, teamCityProvider, myGetProvider, bambooProvider, continuaCIProvider, null, bitriseProvider, travisCIProvider, bitbucketPipelinesProvider, gitlabCIProvider));
            ...
            public void Should_Throw_If_Bitrise_Is_Null()
            {
                ...
                // When
                var result = Record.Exception(() => new BuildSystem(appVeyorProvider, teamCityProvider, myGetProvider, bambooProvider, continuaCIProvider, jenkinsProvider, null, travisCIProvider, bitbucketPipelinesProvider, gitlabCIProvider));
            ...
            public void Should_Throw_If_TravisCI_Is_Null()
            {
                ...
                // When
                var result = Record.Exception(() => new BuildSystem(appVeyorProvider, teamCityProvider, myGetProvider, bambooProvider, continuaCIProvider, jenkinsProvider, bitriseProvider, null, bitbucketPipelinesProvider, gitlabCIProvider));
            ...
            public void Should_Throw_If_BitbucketPipelines_Is_Null()
            {
                ...
                // When
                var result = Record.Exception(() => new BuildSystem(appVeyorProvider, teamCityProvider, myGetProvider, bambooProvider, continuaCIProvider, jenkinsProvider, bitriseProvider, travisCIProvider, null, gitlabCIProvider));
        ...
        public sealed class TheIsRunningOnAppVeyorProperty
        {
            ...
            public void Should_Return_True_If_Running_On_AppVeyor()
            {
                ...
                var buildSystem = new BuildSystem(appVeyorProvider, teamCityProvider, myGetProvider, bambooProvider, continuaCIProvider,  jenkinsProvider, bitriseProvider, travisCIProvider, bitbucketPipelinesProvider, gitlabCIProvider);
        ...
        public sealed class TheIsLocalBuildProperty
        {
            ...
            public void Should_Return_False_If_Running_On_TeamCity()
            {
                ...
                travisCIProvider.IsRunningOnTravisCI.Returns(false);
                bitbucketPipelinesProvider.IsRunningOnBitbucketPipelines.Returns(false);
                gitlabCIProvider = Substitute.For<IGitLabCIProvider>();
                var buildSystem = new BuildSystem(appVeyorProvider, teamCityProvider, myGetProvider, bambooProvider, continuaCIProvider, jenkinsProvider, bitriseProvider, travisCIProvider, bitbucketPipelinesProvider, gitlabCIProvider);
